...
>>> 
=== RESTART: C:/Users/dell/AppData/Local/Programs/Python/Python38/gggggggg.py ==
Traceback (most recent call last):
  File "C:/Users/dell/AppData/Local/Programs/Python/Python38/gggggggg.py", line 8, in <module>
...
class MyApp(QWidget, Ui_MainWindow):
    ...
    def gettarget(self):
        blacklist = ['9hea','vox_here', '70irl' , '7ra8o'  ,'7re8o' , 'zixll1' , 'z89lr' , 'vgbi' , 'i.p72' , 'rl_5'  ,'cvgca'  ,'0jkq',  '19g.3',  'b8.here' , '1il88l'  ,'z88lr' , 'b8pw' , 'vox.here']
        if self.tabWidget.currentIndex() == 0:
            mylist = self.textEdit
